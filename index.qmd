...
![](images/clipboard-3327526009.png){fig-alt="Alejandro Sánchez Peralta, Head of Department." fig-align="left" width="218"}
...
```{r}
descarga_zip = function (url, descargaZipen, descomprimeZipen, borra_zip) 
{
    download.file(url, destfile = descargaZipen, mode = "wb")
    unzip(zipfile = descargaZipen, exdir = descomprimeZipen)
    if (borra_zip == FALSE) {
        print("Se almacenan el file en formato .ZIP")
    }
    else {
        print("Se borraron los files zipeados")
        unlink(descargaZipen)
    }
}

descarga_zip(url="https://www.inegi.org.mx/contenidos/programas/enaid/2019/microdatos/enaid2019_bd_dbf.zip",
             descargaZipen = "D:/OneDrive - INEGI/Documents/varios/plantillas_personalizadas/datos/dataset.zip", 
             descomprimeZipen = "D:/OneDrive - INEGI/Documents/varios/plantillas_personalizadas/datos/",
             borra_zip = TRUE)
...
![](images/clipboard-3171556056.png){width="497"}
...
![](images/clipboard-199746887.png){width="671"}
...
![](images/clipboard-3230544090.png){width="415"}
